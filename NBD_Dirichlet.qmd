...
![Gamma distributions with varying shape
parameters](images/Gamma_distributions.png){fig-alt="three Gamma distributions"
...
![Poisson density
distribution](images/poisson_distribution.png){fig-align="right"
width="400"}

\nopagebreak

*(We use line charts here for ease of viewing three Poisson
distributions: Ordinarily, we would use bar-charts to show integer
values on the x-axis. We can't have "half an event")*

Mixing the *Gamma* and *Poisson* distributions yields the *Negative
Binomial*.
...
*realisations* across brands in a period follow a **multinomial**
distribution.
...
$$
f(p_1 , \dots , p_m \mid  \, \alpha_1, \dots, \alpha_m)
