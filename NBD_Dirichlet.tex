...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, opacitybacktitle=0.6, rightrule=.15mm, opacityback=0, breakable, colframe=quarto-callout-note-color-frame, toptitle=1mm, leftrule=.75mm, toprule=.15mm, left=2mm, bottomtitle=1mm, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{How to Think About the Dirichlet}, arc=.35mm, colback=white, coltitle=black]
